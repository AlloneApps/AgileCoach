package com.task.agilecoach.helpers.myTaskToast;
...
public class MyTasksToast {

    public static final int MYTASKS_TOAST_LENGTH_SHORT = Toast.LENGTH_SHORT;
    public static final int MYTASKS_TOAST_LENGTH_LONG = Toast.LENGTH_LONG;
